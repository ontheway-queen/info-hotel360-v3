...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "THEHOTEL360 | Complete Hotel Management Software" },
      {
        name: "description",
        content:
          "Manage reservations, front office, accounting, night audit, online booking, inventory, HRM and settlement with THEHOTEL360.",
      },
      { property: "og:title", content: "THEHOTEL360 | Complete Hotel Management Software" },
      { property: "og:description", content: "The complete operating system for modern hotels." },
    ],
  }),
});
    ...
    <>
      ...
      <Section>
        ...
        <div className="mt-10 text-center">
          <Link to="/why-thehotel360" className="text-primary font-semibold hover:underline">
            {t.common.learnMore} →
          </Link>
        </div>
      </Section>
      ...
      <Section className="bg-soft/40 !max-w-none px-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 text-center">
            <Link to="/modules" className="text-primary font-semibold hover:underline">
              {t.common.learnMore} →
            </Link>
          </div>
        </div>
      ...
      <Section className="bg-gradient-dark !max-w-none px-0 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10">
          <div>
            ...
            <Link to="/cash-drawer" className="text-primary font-semibold hover:underline">
              {t.common.learnMore} →
            </Link>
          </div>
          <div>
            ...
            <Link to="/settlement" className="text-primary font-semibold hover:underline">
              {t.common.learnMore} →
            </Link>
          </div>
        </div>
